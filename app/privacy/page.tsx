        ...
        <div className="space-y-8 text-gray-700">
          <section>
            ...
            <p className="leading-relaxed">
              Welcome to OnlineCalc. We respect your privacy and are committed to protecting your personal data. 
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              OnlineCalc does <strong>not</strong> require you to create an account or provide personal information 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              OnlineCalc uses browser local storage to save your recent calculator history and preferred currency 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              OnlineCalc uses minimal cookies and browser storage for essential functionality such as saving your 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              OnlineCalc is suitable for all ages. We do not knowingly collect personal information from children 
          ...
          <section className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
            <p className="text-sm text-gray-700 mb-3">
              <strong>Key Takeaway:</strong> OnlineCalc is designed with privacy in mind. We don't require accounts, 
