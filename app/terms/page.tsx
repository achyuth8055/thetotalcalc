        ...
        <div className="space-y-8 text-gray-700">
          <section>
            ...
            <p className="leading-relaxed">
              By accessing and using CalcWorld, you accept and agree to be bound by these Terms of Service. 
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              CalcWorld provides free online calculators for various purposes including:
            </p>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">When using CalcWorld, you agree to:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              ...
              CalcWorld does not guarantee the accuracy, completeness, or reliability of any calculation results.
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-4 mb-4">
              ...
              <p className="text-sm text-gray-700">
                CalcWorld calculators do <strong>not</strong> constitute professional advice. Our tools are for 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              All content, design, code, and functionality of CalcWorld are owned by us and protected by 
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              CalcWorld may integrate third-party services (such as currency detection APIs). We are not 
              responsible for:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              To the fullest extent permitted by law, CalcWorld and its operators shall not be liable for:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              CalcWorld is provided free of charge on an "as available" basis. We do not guarantee:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Your use of CalcWorld is also governed by our Privacy Policy. Please review it to understand 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              immediately upon posting. Your continued use of CalcWorld after changes constitutes acceptance 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              We reserve the right to terminate or restrict your access to CalcWorld at our discretion, 
          ...
          <section className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
            ...
            <p className="text-sm text-gray-700 mb-2">
              CalcWorld provides free calculators for general informational purposes. While we strive for accuracy:
            </p>
            ...
            <p className="text-sm text-gray-700 mt-3">
              <strong>By using CalcWorld, you acknowledge and accept these terms.</strong>
            </p>
          </section>
        </div>
      </div>
